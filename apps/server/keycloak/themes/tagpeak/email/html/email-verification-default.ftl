                                                ...
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                        ...
                                                        <div style="font-size: 13px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                            <p style="line-height: 140%;"> </p>
                                                            <p style="line-height: 140%;">To complete your registration, please verify your email address by clicking the link below:</p>
                                                            <p style="line-height: 140%;"> </p>
                                                            ...
                                                            <p style="line-height: 140%;"> </p>
                                                            <p style="line-height: 140%;">If you didn’t create this account, you can safely ignore this message.</p>
                                                        </div>
