...
<#--${kcSanitize(msg("identityProviderLinkBodyHtml", identityProviderDisplayName, realmName, identityProviderContext.username, link, linkExpiration, linkExpirationFormatter(linkExpiration)))?no_esc}-->
    ...
    <div class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: white;color: #000000">
        <table
                                                        ...
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                ...
                                                                <div style="font-size: 13px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="line-height: 140%;"> </p>
                                                                    <p style="line-height: 140%;">Someone wants to link your account with ${identityProviderDisplayName} account of user ${identityProviderContext.username}. If this was you, click the link below to link accounts</p>
                                                                    <p style="line-height: 140%;"> </p>
                                                                    <p style="line-height: 140%; ">👉 <a href="${link}" style="text-decoration:none">Link to confirm account linking</a></p>
                                                                    <p style="line-height: 140%;"> </p>
                                                                    <p style="line-height: 140%;">This link will expire within ${linkExpirationFormatter(linkExpiration)} for security reasons.</p>
                                                                    <p style="line-height: 140%;"> </p>
                                                                    <p style="line-height: 140%;">If you don't want to link account, just ignore this message. If you link accounts, you will be able to login to through ${identityProviderDisplayName}.</p>
                                                                </div>
