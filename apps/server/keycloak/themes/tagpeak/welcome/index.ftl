  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/atlanse_logo.svg" alt="Atlanse logo" border="0" />
        <img src="${resourcesPath}/logo.png" alt="${productName}" border="0" />
        <h1>Welcome to <strong class="productNameClass"></strong></h1>
      </div>
      <div class="row">
...
<#--          <img src="welcome-content/jboss_community.png" alt="JBoss and JBoss Community">-->
<#--        </a>-->
<#--        </#if>-->
<#--      </div>-->
    </div>
