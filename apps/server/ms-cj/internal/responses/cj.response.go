...
type CJAffiliateResponse[T any] struct {
	Data   T              `json:"data"`
...
type CommissionItem struct {
	...
	PerItemSaleAmountAdvCurrency types.FlexibleFloat64 `json:"perItemSaleAmountAdvCurrency"`
	PerItemSaleAmountPubCurrency types.FlexibleFloat64 `json:"perItemSaleAmountPubCurrency"`
	PerItemSaleAmountUSD         types.FlexibleFloat64 `json:"perItemSaleAmountUsd"`
	TotalCommissionAdvCurrency   types.FlexibleFloat64 `json:"totalCommissionAdvCurrency"`
	TotalCommissionPubCurrency   types.FlexibleFloat64 `json:"totalCommissionPubCurrency"`
	TotalCommissionUSD           types.FlexibleFloat64 `json:"totalCommissionUsd"`
}
...
type CJAffiliateDataAid struct {
