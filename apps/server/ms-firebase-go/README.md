...
we have to ways to associate a user to a topic:
- granular: associate a token (device) to a topic. This enables per device notifications.
- user: associate a user to a topic. This enables per user notifications.

- granular: associate a token (device) to a topic. This enables per device notifications. (must be configured)
- user: associate a user to a topic. This enables per user notifications. this is the default one
