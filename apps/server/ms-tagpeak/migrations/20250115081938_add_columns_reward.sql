...
alter table reward
add withdrawal_uuid uuid
    constraint reward_withdrawal_uuid_fk
        references withdrawal;

alter table reward
add override_price double precision;
...
BEGIN
    ...
    INSERT INTO reward_audit (reward_uuid, action, "user", transaction_uuid, isin, initial_reward,
                              ...
                              currency_target, currency_user, state, initial_price, end_date, asset_units, type, override_price, withdrawal_uuid,
    ...
    VALUES (NEW.uuid, trigger_action, NEW."user", NEW.transaction_uuid, NEW.isin, NEW.initial_reward,
            ...
            NEW.initial_price, NEW.end_date, NEW.asset_units, NEW.type, NEW.override_price, NEW.withdrawal_uuid,
            NEW.created_at, NEW.created_by, NEW.updated_at,
