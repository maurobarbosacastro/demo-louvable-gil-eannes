...
alter table reward add stopped_at timestamp(6);

alter table reward_audit add stopped_at timestamp(6);
...
BEGIN
    ...
    VALUES (NEW.uuid, trigger_action, NEW."user", NEW.transaction_uuid, NEW.isin, NEW.initial_reward,
            ...
            NEW.updated_by, NEW.deleted_at, NEW.deleted_by, NEW.deleted, NEW.legacy_id, NEW.stopped_at);
